...
function ToutDecocher() {
    ...
    $('input:checkbox[name=PetitPeuple]').attr('checked', false);
    ...
    $('input:checkbox[name=Plantescarnivores]').attr('checked', false);
    ...
    $('input:checkbox[name=UniversitéMiskatonic]').attr('checked', false);
    ...
    $('input:checkbox[name=Fourmisgéantes]').attr('checked', false);
    ...
    $('input:checkbox[name=MythologiesGrecques]').attr('checked', false);
    ...
    $('input:checkbox[name=AncientEgyptians]').attr('checked', false);
    ...
    $('input:checkbox[name=PolynesianVoyagers]').attr('checked', false);
