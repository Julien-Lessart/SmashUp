...
function ToutDecocher() {
    ...
    $('input:checkbox[name=Dinosaures]').attr('checked', false);
    ...
    $('input:checkbox[name=Petit Peuple]').attr('checked', false);
    $('input:checkbox[name=Magiciens]').attr('checked', false);
    $('input:checkbox[name=Zombies]').attr('checked', false);
    $('input:checkbox[name=Cavalerie ours]').attr('checked', false);
    $('input:checkbox[name=Fantômes]').attr('checked', false);
    $('input:checkbox[name=Plantes carnivores]').attr('checked', false);
    $('input:checkbox[name=Steampunks]').attr('checked', false);
    $('input:checkbox[name=Grands Anciens]').attr('checked', false);
    $('input:checkbox[name=Innsmouth]').attr('checked', false);
    $('input:checkbox[name=Serviteurs de Cthulhu]').attr('checked', false);
    $('input:checkbox[name=Université Miskatonic]').attr('checked', false);
    $('input:checkbox[name=Singes cyborgs]').attr('checked', false);
    $('input:checkbox[name=Métamorphes]').attr('checked', false);
    $('input:checkbox[name=Super espions]').attr('checked', false);
    $('input:checkbox[name=Voyageurs du temps]').attr('checked', false);
    $('input:checkbox[name=Fourmis géantes]').attr('checked', false);
    $('input:checkbox[name=Scientifiques fous]').attr('checked', false);
    $('input:checkbox[name=Vampires]').attr('checked', false);
    $('input:checkbox[name=Loup-garous]').attr('checked', false);
    $('input:checkbox[name=Fées]').attr('checked', false);
    $('input:checkbox[name=Chatons mignons]').attr('checked', false);
    $('input:checkbox[name=Chevaux Mythiques]').attr('checked', false);
    $('input:checkbox[name=Princesses]').attr('checked', false);
    $('input:checkbox[name=Prêtres]').attr('checked', false);
    ...
    $('input:checkbox[name=Mythologies Grecques]').attr('checked', false);
    $('input:checkbox[name=Requins]').attr('checked', false);
    $('input:checkbox[name=Super-Héros]').attr('checked', false);
    $('input:checkbox[name=Tornades]').attr('checked', false);
    $('input:checkbox[name=Chevaliers des Etoiles]').attr('checked', false);
    $('input:checkbox[name=Changeformers]').attr('checked', false);
    $('input:checkbox[name=Squatteurs de Trône]').attr('checked', false);
    $('input:checkbox[name=Voyageurs de lespace]').attr('checked', false);
    $('input:checkbox[name=Explorateurs]').attr('checked', false);
    $('input:checkbox[name=Grand mères]').attr('checked', false);
    $('input:checkbox[name=Grouppies]').attr('checked', false);
    $('input:checkbox[name=Nounours]').attr('checked', false);
    $('input:checkbox[name=Itty Critters]').attr('checked', false);
    $('input:checkbox[name=Kaiju]').attr('checked', false);
    $('input:checkbox[name=Magical Girls]').attr('checked', false);
    $('input:checkbox[name=Mega Troopers]').attr('checked', false);
    $('input:checkbox[name=Sheep]').attr('checked', false);
    $('input:checkbox[name=Disco Dancers]').attr('checked', false);
    $('input:checkbox[name=Star Kung Fu Fighters]').attr('checked', false);
    ...
    $('input:checkbox[name=Smash Up All Stars]').attr('checked', false);
    $('input:checkbox[name=Cowboys]').attr('checked', false);
    $('input:checkbox[name=Ancient Egyptians]').attr('checked', false);
    ...
    $('input:checkbox[name=Sumo Wrestlerskers]').attr('checked', false);
    $('input:checkbox[name=Penguins]').attr('checked', false);
    $('input:checkbox[name=Anansi Tales]').attr('checked', false);
    $('input:checkbox[name=Ancient Incas]').attr('checked', false);
    $('input:checkbox[name=Grimms’ Fairy Tales]').attr('checked', false);
    $('input:checkbox[name=Polynesian Voyagers]').attr('checked', false);
    $('input:checkbox[name=Russian Fairy Tales]').attr('checked', false);
}